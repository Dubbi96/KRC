...
exports.RetryPolicyEngine = exports.DEFAULT_RETRY_RULES = void 0;
/** 기본 재시도 정책 */
exports.DEFAULT_RETRY_RULES = [
    {
        name: 'infra-retry',
        when: {
...
class RetryPolicyEngine {
    rules;
    constructor(rules) {
        this.rules = rules || exports.DEFAULT_RETRY_RULES;
    }
    /**
     * 재시도 여부를 판단한다.
     *
     ...
     * @returns 재시도 판단 결과
     */
    shouldRetry(outcomeClass, signals, platform, currentAttempt) {
        ...
        const matchingRules = this.rules.filter(rule => this.matchesCondition(rule.when, outcomeClass, signals, platform));
        // 플랫폼 특화 룰 우선
    ...
    matchesCondition(condition, outcomeClass, signals, platform) {
        ...
        if (condition.hasCoordinateFallback !== undefined) {
            ...
            if (hasIt !== condition.hasCoordinateFallback)
                return false;
        }
...
exports.RetryPolicyEngine = RetryPolicyEngine;
