...
exports.ScenarioComposer = void 0;
class ScenarioComposer {
    storage;
    resolvedIds = new Set(); // 순환 참조 방지
    constructor(storage) {
    ...
    normalizeNavigations(events) {
        ...
        for (let i = 0; i < events.length; i++) {
            ...
            if (isObservedNavigate(current) && current.url) {
                ...
                while (prevIdx >= 0 && (result[prevIdx].disabled ||
