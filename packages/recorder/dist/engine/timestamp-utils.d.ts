...
export interface NormalizeTimestampsOptions {
    /** 스텝 간 허용 최대 gap (ms). 이를 초과하면 defaultGap으로 보정. 기본 30000 (30초) */
    maxGap?: number;
    /** 보정 시 사용할 기본 gap (ms). 기본 500 */
    defaultGap?: number;
}
/**
 ...
 * @returns 보정된 스텝 수
 */
export declare function normalizeTimestamps(events: RecordingEvent[], options?: NormalizeTimestampsOptions): number;
